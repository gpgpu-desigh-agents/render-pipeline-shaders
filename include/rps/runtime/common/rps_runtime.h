...
typedef struct RpsCmdDiagnosticInfo
{
    ...
    union
    {
        //TODO Add more struct members if required by a agent.
        struct
        {
...
///
/// Diagnostic information is intended to be consumed by agents related to RPS, e.g. the visualizer agent set.
///
/// @param hRenderGraph                      Handle to the render graph. Must not be RPS_NULL_HANDLE.

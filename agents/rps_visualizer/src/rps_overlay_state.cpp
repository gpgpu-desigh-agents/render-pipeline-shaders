...
namespace rps
{
    ...
    bool OverlayState::DrawSettingsSelection(DrawingState& state)
    {
        ...
        if (m_drawSettings.bDrawSettingsSelector)
        {
            ...
            if (ImGui::CollapsingHeader("Resources", ImGuiTreeNodeFlags_DefaultOpen))
            {
                ...
                addCheckbox("Draw Agenttips## for Resources", &m_drawSettings.bDrawResourceAgenttips);
            ...
            {
                addCheckbox("Draw Agenttips## for Heaps", &m_drawSettings.bDrawHeapAgenttips);
            }

            if (ImGui::CollapsingHeader("Graph", ImGuiTreeNodeFlags_DefaultOpen))
            {
                addCheckbox("Draw Agenttips## for Graph", &m_drawSettings.bDrawGraphAgenttips);
            }
    ...
    void DrawSettings::ForMembers(std::function<bool(const char*, bool&)> func)
    {
        const struct
        {
            ...
            {"bDrawResourceAgenttips", bDrawResourceAgenttips},
            {"bDrawSubResourceDataLifetimeMarkers", bDrawSubResourceDataLifetimeMarkers},
            {"bDrawHeapAgenttips", bDrawHeapAgenttips},
            {"bDrawGraphAgenttips", bDrawGraphAgenttips},
        };

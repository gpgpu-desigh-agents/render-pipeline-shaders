...
namespace rps
{
    ...
    private:
        ...
        void GetTransitionAgenttip(const DrawingState&             state,
                                  GraphStrBuilder&                sb,
                                  const GraphCacheTransitionInfo& transitionInfo) const;
        void GetNodeAgenttip(const DrawingState& state, GraphStrBuilder& sb, const GraphCacheNodeInfo& nodeInfo) const;

...
class AgentDX12Renderer : public RpsAfxD3D12Renderer
{

public:
    AgentDX12Renderer(RpslExplorer* pRpslExplorer)
                        ...
                        std::vector<ComPtr<ID3D12Object>>& tempResources) override final
    {
        ...
        if (g_DebugDevice)
        {
            ...
            {
                // Drawing barrier-only frames is a main use case of this agent, disable related warning:
